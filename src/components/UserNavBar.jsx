...
function UserNavBar() {
  return (
    <nav className='w-[100%] h-[60px] bg-purp-dark flex justify-between items-center'>
      ...
      <SearchBar />  
      <Link to="/login" className="h-[40px] flex items-center justify-center text-white sm:py-1.5 sm:px-2 mr-4 sm:rounded-lg sm:border-solid sm:border-2 sm:border-white hover:scale-105 transition">
